...
class ReponseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $reponses = $em->getRepository('ForumBundle:Reponse')->findAll();
    ...
    {
        $reponse = new Reponse();
        $form = $this->createForm('ForumBundle\Form\ReponseType', $reponse);
    ...
    {
        $deleteForm = $this->createDeleteForm($reponse);
        $editForm = $this->createForm('ForumBundle\Form\ReponseType', $reponse);
